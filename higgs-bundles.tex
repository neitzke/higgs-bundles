...
If we define
\begin{align}
  w(\zeta) &= w_1 + \I \bar{z}_1 \zeta, \\
  z(\zeta) &= z_1 - \I \bar{w}_1 \zeta,
\end{align}
...
Indeed,
\begin{align}
  \frac{1}{2\zeta} \de w(\zeta) \wedge \de z(\zeta) &= \frac{1}{2\zeta} (\de w_1 \wedge \de z_1 - \I \zeta (\de w_1 \wedge \de \bar{w}_i + \de z_1 \wedge \de \bar{z}_1) + \zeta^2 \de \bar{z}_1 \wedge \de \bar{w}_1) \\
  &= \frac{\omega_2 + \I \omega_3}{2\zeta} - \omega_1 + \frac{-\omega_2 + \I \omega_3}{2} \zeta
\end{align}
...
\end{equation}
The involution $\rho$ acts by \fixme{check}
\begin{equation} \label{eq:involution-R4}
  (\zeta, z, w) \to (-1/\bar\zeta, \bar w / \bar\zeta, -\bar z / \bar \zeta).
\end{equation}
