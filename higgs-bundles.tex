...
A \ti{$\vartheta$-trajectory} of $Q$ is a real $1$-manifold $p$ on $C$
such that $e^{- \I \vartheta} \sqrt Q$ (with either choice of sign) is a
\ti{real} and nowhere vanishing form on $p$. 
Given a $\vartheta$-trajectory $p$, its lift to $\Sigma_{\vec\phi}$
is canonically oriented. Call a \ti{$\vartheta$-trajectory} \ti{maximal} if
