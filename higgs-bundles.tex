...
structure. To make this precise, first observe the following:
\fixme{...}

\begin{defn} Given a \hk manifold $X$, the \ti{twistor space}
of $X$ is the manifold
\begin{equation}
  \cZ = X \times S^2
\end{equation}
...
\end{equation}
where $I_{S^2}$ denotes the canonical complex structure on $S^2$.
\end{defn}
