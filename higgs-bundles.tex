...
\usepackage[bibstyle=authoryear-comp,labeldate=false,defernumbers=true,maxnames=20,giveninits=true,uniquename=init,dashed=false,backend=biber,sorting=none]{biblatex}
...
\item $C'$ contains finitely many cells
$C_i$, such that $C_i$ is foliated by $\vartheta$-trajectories all of which are homotopic, and all of which are forward and backward asymptotic to punctures,
\item $C' \setminus \cup C_i$ consists of the critical trajectories.
\end{itemize}
\end{prop}
