...
Suppose $V$ is a quaternionic vector space, 
with a real subspace $W \subset V$, such that
$I_i W \cap W = \{ 0 \}$ for $i = 1,2,3$.
Suppose also
\begin{equation}
 w_0 + I_1 w_1 + I_2 w_2 + I_3 w_3 = 0, \qquad w_i \in W.
\end{equation}
Then show that $w_0 = w_1 = w_2 = w_3 = 0$. \fixme{warning, this is 
unchecked so far!}
\end{exercise}
