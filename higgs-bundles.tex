...
(indeed the symbol is just $K^2$ copies of the symbol 
of $\de + \de^*$.)
Thus we get:
...
\end{equation}
Very generally, for any elliptic operator, this could be 
computed by the Atiyah-Singer Index Theorem; in the present
case though, all we need to know is one of the basic
