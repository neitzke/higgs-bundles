...
Now we consider our construction of the moduli space from
...
As before we fix a compact Riemann surface $C$ and two integers
$K \ge 2$ and $d$.
We are going to define a moduli space $\cM_{K,d}(C)$ which can be
studied, and thought of, in several different ways.
One way to understand it is as ``moduli space of Higgs bundles.''
We consider this picture first.
...
Our interest is in the moduli space of Higgs bundles.
