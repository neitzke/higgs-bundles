...
\begin{example}[Sobolev spaces] If $E$ is a complex
vector bundle over a Riemannian manifold $X$, and $k \ge 0$,
$1 < p < \infty$, we define the \ti{Sobolev space}
$L^p_k(E)$ to be the completion of the space of smooth
compactly supported sections of $E$, with respect to a certain
norm $\norm{\cdot}$. \fixme{...}
\end{example}
