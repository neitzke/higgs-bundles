...
a tuple $(X,g,I,J,K)$, where $(X,g)$ is a Riemannian 
manifold equipped with three complex 
structures $I$, $J$, $K$, obeying the algebra of the quaternions ($IJ = -JI = K$),
such that $g$ is Hermitian and \kahler with respect to
any of $I$, $J$, $K$.
\end{defn}

It is crucial that we require the \ti{single} metric
$g$ to be \kahler for \ti{all} of $I$, $J$, $K$:
...
Show that the complex 2-form $\omega_J + \I \omega_K$
