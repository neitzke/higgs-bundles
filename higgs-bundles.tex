...
\end{equation}
Also $(2)$ implies that
for $v \in T^{0,1} X$ and $w$ a section of $T^{1,0} X$,
...
and $V \partial_\chi + \I \hat\partial_1$, where the hat means
the parallel lift determined by $\Theta$, i.e. the lift
...
\fixme{it has a holomorphic vector field
$V \partial_\chi - \I \hat \partial_1$ --- would
integrate to $\C^\times$ action --- like a principal
$\C^\times$-bundle}
