...
Hilbert manifolds, but then we will always say ``Hilbert manifold''
...
\eqref{eq:V-ooguri-vafa-resummed}.
\end{exercise}
...
\fixme{also Gibbons-Hawking spaces}
...
group $\fG$ whose action is proper, and then interpret \eqref{eq:bunG-formal-quotient}
...
\begin{prop}[$\fG$ action on $\cA$ preserves symplectic structure]
\end{prop}
