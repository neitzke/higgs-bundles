...
would be to take the 1-dimensional lattice of points \fixme{oops, need to put a 2pi in here}
\begin{equation}
  x_n = (n,0,0) \in \R^3
\end{equation}
...
\begin{equation} \label{eq:Xsf-ooguri-vafa}
  \cX_B^{\sf} = \exp \left(\zeta^{-1} Z_2 + \I \chi + \zeta \bar{Z}_2 \right),
\end{equation}
where \fixme{check factor}
\begin{equation}
  Z_2 = \frac{1}{4 \pi \I} (z \log (z/\Lambda) - z).
\end{equation}
