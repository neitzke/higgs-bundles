...
\usepackage[bibstyle=numeric,defernumbers=true,maxnames=20,uniquename=init,dashed=false,backend=biber,sorting=none,bibencoding=utf8,casechanger=latex2e]{biblatex}
...
at
\begin{center}
\small \url{https://gauss.math.yale.edu/~an592/exports/higgs-bundles.pdf}
\end{center}
