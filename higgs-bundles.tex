...
\subsection{More on twistor spaces}
...
(In formulating this condition we use the standard real
structure on $\cO(2)$ covering $\sigma$, induced from the
map $(x,y) \mapsto (-y,x)$ on $\cO(1)$.)
\end{enumerate}
\end{enumerate}
\end{prop}
...
reconstruction, \autoref{thm:hk-twistor-construction}: all you 
...
that $g$ is actually a \hk metric.\fixme{...}
\end{pf}
