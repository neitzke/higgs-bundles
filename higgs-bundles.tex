...
<<<<<<< HEAD
even if we allow some bounded amount of 
curvature, we still get a kind of weak compactness
when we divide out by gauge transformations.
=======
...
>>>>>>> 72c2c9577fc51abc1d1a71ef4ec0881612837a0f
...
For this, we fix some holomorphic line bundle $\tilde{d}$ of degree $d$
on $C$. (If $d=0$ then it would be natural to take
 $\tilde{d}$ to be the trivial bundle.) \fixme{...}
