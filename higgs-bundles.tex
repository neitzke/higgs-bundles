...
on $U$:\footnote{On the RHS $\delta$ means
...
\begin{example}[Multi-Eguchi-Hanson spaces] \cite{MR520463} \label{exa:multi-eguchi-hanson} More generally we can fix a collection
