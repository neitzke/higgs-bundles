...
\begin{defn}[Generalized Ooguri-Vafa space]
...
we have at least some \ti{asymptotic} information, thanks to the following
theorem.

\begin{thm}[Gross-Wilson asymptotic description of K3 metrics] \cite{MR1863732}
Fix an elliptically fibered K3 surface $X$ as in 
\autoref{exa:elliptically-fibered-k3}. There exists a family
of \kahler classes $\alpha(R) \in H^{1,1}_\R(X)$, 
parameterized by $R \in \R_+$, such that the corresponding \hk metrics $g(R)$
\fixme{...}
\end{thm}
