...
formula, which also shows that the corrections are
...
\begin{thm}[Compact, \kahler, uniquely holomorphic symplectic, simply connected manifolds are uniquely \hk] \label{thm:hol-symp-is-hk}
Suppose that:
\begin{itemize}
...
Note that \autoref{thm:hol-symp-is-hk} is not explicit: Yau's Theorem
