...
When $G$ is compact, moment maps exist at least
\ti{locally}, though maybe not globally.
...
vectors $\rho(Z)$ or $I \rho(Z)$, for $Z \in \fg$.
There is another way of thinking about this:
these vectors generate a copy of the \ti{complexified}
...
\begin{equation}
  X \kq G = X / G_\C.
\end{equation}
If we try to realize this dream literally, we will run into 
...
we can still have some problems, because $G_\C$ 
