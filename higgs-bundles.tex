...
Then the $\fG_\C$-orbit of $\bar\partial$ contains 
a point of $\mu^{-1}(0)$, i.e. an Einstein connection.
\end{cor}

\begin{pf} By \autoref{lem:einstein-connections-on-line-bundles} 
the holomorphic line bundle $(E,\bar\partial)$ admits
a Hermitian metric $h'$ such that the Chern connection
...
$(E,\bar\partial^g, h)$ is Einstein, as desired. \fixme{check sign}
\end{pf}
...
(else a short computation shows that a 
gauge transformation with parameter $Z$ obeying
