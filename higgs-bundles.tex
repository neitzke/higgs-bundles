...
\begin{lem}[Saturation of maps between bundles of same rank and degree] \label{lem:saturation-of-bundle-maps}
...
\end{prop}
\begin{pf}
To prove this it is sufficient to exhibit one Higgs bundle in each fiber.
For $K=2$ we have already done this above, in \autoref{exa:hitchin-section-K2}.
