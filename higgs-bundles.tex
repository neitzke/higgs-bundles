...
\chead{\tiny \ti{Moduli of Higgs Bundles, preliminary and incomplete draft}}
...
\begin{equation} \label{eq:harmonic-curvature}
  F_D = -2 \pi \I \frac{d}{K} {\mathbf 1} \omega_C.
\end{equation}
...
on sections of $\fu(E)$, since $F_D = 2 \pi \I $ is central.)
...
\kahler manifold, of dimension $(g-1)K^2 + 1$.
\end{cor}
...
Namely, suppose we consider \fixme{...}
...
$D' = D \otimes D_\cL$ in $E' = E \otimes \cL$ is also Einstein. 
