...
and $V \partial_\chi + \I \hat\partial_1$, where the hat denotes
the parallel lift determined by $\Theta$. Thus
...
$z_1$ is a holomorphic map, $z_1: X \to \C$.

Similarly we can define $I_2$, $I_3$.
\fixme{obeying algebraic relations}
\fixme{as complex manifold, it has a holomorphic vector field
