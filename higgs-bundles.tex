...
The definition of Banach Lie group is just as in the 
...
are smooth. \fixme{ref Glockner-Neeb coming out Apr 14?}
...
with one difference: instead of mapping to $\fg^*$
we just require that $\mu$ maps to some Banach space $W$
which has a nondegenerate pairing with $\fg$.
\end{defn}
...
\begin{pf}
We have described $\cN^s_{K,d}(C)$ as a symplectic quotient
