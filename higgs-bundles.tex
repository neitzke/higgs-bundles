...
$\alpha$'s, the $f_\alpha$ give a coordinate system on
...
with the difference that we are in higher dimension (in \autoref{exa:semiflat-1d-general}
we constructed a space of complex dimension $2$),
